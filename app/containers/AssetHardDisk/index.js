...
export function AssetHardDisk({
  ...
  useInjectReducer({ key: 'assetHardDisk', reducer });
  useInjectSaga({ key: 'assetHardDisk', saga });
  useEffect(()=>{
    OnLoadModelItems();
  },[])
    ...
    <div className="main-content-container px-2 py-2 container-fluid">      
      <Container className="d-flex justify-content-center"> 
        <AssetMgmtTableCard 
          ...
          cardTitle = "Hard Disks"
          modelName = "Sizes/hardisk"
