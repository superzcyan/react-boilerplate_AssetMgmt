...
import { sizesTableheader } from '../../components/AssetMgmtItemTable/tableHeaders';
...
export function AssetVideoCard({
  ...
  useInjectReducer({ key: 'assetVideoCard', reducer });
  useInjectSaga({ key: 'assetVideoCard', saga });
  useEffect(()=>{
    OnLoadModelItems();
  },[])
    ...
    <div className="main-content-container px-2 py-2 container-fluid">      
      <Container className="d-flex justify-content-center"> 
        <AssetMgmtTableCard 
          ...
          cardTitle = "Video Cards"
          modelName = "Sizes/videocard"
          modelItems = {modelItems}
          tableHeaders = {sizesTableheader}
