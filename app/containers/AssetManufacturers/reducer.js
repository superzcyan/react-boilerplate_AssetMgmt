...
const assetManufacturersReducer = (state = initialState, action) =>
  produce(state, draft => {
    switch (action.type) {
      case GET_MODELITEMS:
        draft.loading = true;
        draft.modelTitle = 'Manufacturers';
...
export default assetManufacturersReducer;
