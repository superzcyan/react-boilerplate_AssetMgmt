...
export function AssetManufacturers({
  modelItems = [],
  noItemFound,
  getModelId,
  ...
  useInjectReducer({ key: 'assetManufacturers', reducer });
  useInjectSaga({ key: 'assetManufacturers', saga });
  useEffect(()=>{
    OnLoadModelItems();
  },[])
